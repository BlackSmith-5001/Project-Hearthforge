...
APIキーや外部AIプロバイダへの送信を理解している方は、下の上級者向けBYOK Guild Master Demoをご利用ください。
...
## 🏰 上級者向け BYOK Guild Master Demo 注意
...
不安な場合は、まずAPIキー不要デモを使ってください。生成されたJSONを公開する前に、個人情報、非公開の会話内容、繊細な文脈が含まれていないか確認してください。
